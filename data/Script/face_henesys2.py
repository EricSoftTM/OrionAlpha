...
Author: Eric
NPC: Dr. Feeble
Script: Henesys General Plastic Surgery
'''
...
# Post-Beta: 5152000 => Beta: 4052000
ret = self.askYesNo("If you use the regular coupon, your face can turn into anything... Still want to do this using #bHenesys Cosmetic Surgery Coupon (General)#k?")
if ret == 1:
	face = self.makeRandAvatar(4052000, [changeFace1, changeFace2, changeFace3, changeFace4, changeFace5, changeFace6, changeFace7, changeFace8, changeFace9, changeFace10, changeFace11])
	if face == 1:
	...
	self.say("I see... Just think for a moment if that's really what you want. When you decide, let me know.")